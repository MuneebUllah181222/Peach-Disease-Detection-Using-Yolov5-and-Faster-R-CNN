...
for r, d, f in os.walk("models_train"):
    for file in f:
        if ".pt" in file:
            ...
            dictOfModels[os.path.splitext(file)[0]] = torch.hub.load(r'C:\Users\Muneeb ullah\Object Detection\yolov5', 'custom', path=r'C:\Users\Muneeb ullah\Object Detection\yolov5\runs\train\exp7\weights\YOLO_Model.pt', force_reload=True,source='local')
